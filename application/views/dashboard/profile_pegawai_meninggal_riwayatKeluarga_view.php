                ...
                <div class="box-body scroll">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input class="form-control" id="NAYAH" placeholder="Nama Ayah">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="TLAHIR" class="col-md-4 control-label">Tempat Lahir</label>
                      <div class="col-md-4">
                        <input class="form-control" id="TLAHIR" placeholder="Tempat Lahir">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input class="form-control" id="KKERJA" placeholder="Pekerjaan">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="ALJALAN" class="col-md-4 control-label">Alamat Jalan</label>
                      <div class="col-md-4">
                        <input class="form-control" id="ALJALAN" placeholder="Alamat Jalan">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input class="form-control" id="NOTELP" placeholder="No. Telepon">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="WIL" class="col-md-4 control-label">Kota / Kabupaten</label>
                      <div class="col-md-4">
                        <input class="form-control" id="WIL" placeholder="Kota / Kabupaten">
                      </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="box-body scroll">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input class="form-control" id="NIBU" placeholder="Nama Ibu">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="TLAHIR" class="col-md-4 control-label">Tempat Lahir</label>
                ...
                <div class="box-body scroll">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input class="form-control" id="NISUA" placeholder="Nama Istri / Suami">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input class="form-control" id="TIJASAH" placeholder="Pendidikan">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input class="form-control" id="STUNJ" placeholder="Status Tunjangan">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="KKERJA" class="col-md-4 control-label">Pekerjaan</label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input class="form-control" id="ISAKHIR" placeholder="Istri / Suami Terakhir">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="box-body scroll">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input class="form-control" id="NANAK" placeholder="Nama Anak">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="TLAHIR" class="col-md-4 control-label">Tempat Lahir</label>
                    ...
                    <div class="form-group">
                      <label for="KJKEL" class="col-md-4 control-label">Kelamin</label>
                      <div class="col-md-4">
                        <input class="form-control" id="KJKEL" placeholder="Kelamin">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="KELUARGA" class="col-md-4 control-label">Hubungan Keluarga</label>
                      <div class="col-md-4">
                        <input class="form-control" id="KELUARGA" placeholder="Hubungan Keluarga">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="TUNJ" class="col-md-4 control-label">Tunjangan</label>
                      <div class="col-md-4">
                        <input class="form-control" id="TUNJ" placeholder="Tunjangan">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="TIJASAH" class="col-md-4 control-label">Tingkat Pendidikan Umum</label>
                      <div class="col-md-4">
                        <input class="form-control" id="TIJASAH" placeholder="Tingkat Pendidikan Umum">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="KKERJA" class="col-md-4 control-label">Pekerjaan</label>
