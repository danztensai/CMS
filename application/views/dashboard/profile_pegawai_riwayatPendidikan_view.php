...
<div class="tab-pane" id="riwayatPendidikan">
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      ...
      <li><a href="#kursus" data-toggle="Kursus">Kursus</a></li>
                  ...
                  <form class="form-horizontal">
                    <div class="box-body scroll">
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <label for="kodependidikanUmum" class="col-md-4 control-label">Kode Pendidikan Umum</label>
                          <div class="col-md-4">
                            <input class="form-control" id="kodePendidikanUmum" placeholder="Kode Pendidikan Umum">
                          </div>
                        </div>

                        <div class="form-group">
                          <label for="namaPendidikanUmum" class="col-md-4 control-label">Nama Pendidikan Umumt</label>
                          <div class="col-md-4">
                            <input class="form-control" id="namaPendidikanUmum" placeholder="Nama Pendidikan Umum">
                          </div>
                        </div>
