          ...
          <div class="col-md-12">
                <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">PROFILE PEGAWAI PINDAH KELUAR</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                    <div class="nav-tabs-custom">
                                ...
                                <?php
                                  $dataIndukView= $this->load->view('dashboard/profile_pegawai_pindahKeluar_dataInduk_view', '', TRUE);
                                  $dataIndukRiwayatPegawai=$this->load->view('dashboard/profile_pegawai_pindahKeluar_riwayatPegawai_view','',TRUE);
                                  $dataIndukRiwayatPendidikan = $this->load->view('dashboard/profile_pegawai_pindahKeluar_riwayatPendidikan_view','',TRUE);
                                  $dataIndukRiwayatKeluarga = $this->load->view('dashboard/profile_pegawai_pindahKeluar_riwayatKeluarga_view','',TRUE);
                                  echo $dataIndukView;
