                                              ...
                                              <div class="col-md-7">
                                                    ...
                                                    <form class="form-horizontal">
                                                      ...
                                                      <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                          <label for="tglSTTP" class="col-md-4 control-label">tglSTTP</label>
                                                          <div class="col-md-8">
                                                    ...
                                                    <form class="form-horizontal">
                                                      <div class="box-body">
                                                        <div class="col-md-6">
                                                          ...
                                                          <div class="form-group">
                                                            <label for="angkaKredit" class="col-md-2 control-label">Angka Kredit</label>
                                                            <div class="col-md-8">
                                                              <input class="form-control" id="angkaKredit" placeholder="Angka Kredit">
                                                            </div>
                                                          </div>
                                                        </div>
                                                        <div class="col-md-6">
