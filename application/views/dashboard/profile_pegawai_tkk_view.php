...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li>Dashboard</li>
      <li class="active">Pegawai Tkk</li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">PEGAWAI TKK</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="nav-tabs-custom">
              ...
              <div class="tab-content">
                <?php
                $dataIndukView= $this->load->view('dashboard/profile_pegawai_tkk_dataInduk_view', '', TRUE);
                $dataIndukRiwayatPegawai=$this->load->view('dashboard/profile_pegawai_tkk_riwayatPegawai_view','',TRUE);
                $dataIndukRiwayatPendidikan = $this->load->view('dashboard/profile_pegawai_tkk_riwayatPendidikan_view','',TRUE);
                $dataIndukRiwayatKeluarga = $this->load->view('dashboard/profile_pegawai_tkk_riwayatKeluarga_view','',TRUE);
                echo $dataIndukView;
