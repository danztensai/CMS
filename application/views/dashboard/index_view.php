							...
							<div class="nav-tabs-custom">
							            ...
							            <div class="tab-content">
							              <div class="tab-pane active" id="tab_1">
														...
														<IFRAME SRC=<?php echo base_url('dashboard/gridUserManagement');?>></IFRAME>
															</div>
							              ...
							              <div class="tab-pane" id="tab_2">
															<div class="intrinsic-container intrinsic-container-16x9">
														<IFRAME SRC=<?php echo base_url('dashboard/menuManagement');?>></IFRAME>
															</div>
							              </div>
							              <!-- /.tab-pane -->
							              <div class="tab-pane" id="tab_3">
															<div class="intrinsic-container intrinsic-container-16x9">
							               	<IFRAME SRC=<?php echo base_url('dashboard/instansiManagement');?>></IFRAME>
														</div>
							              </div>
							              <!-- /.tab-pane -->
