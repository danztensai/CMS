                              ...
                              <form class="form-horizontal">
                                <div class="box-body scroll">
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                      <label for="lokasiKerja" class="col-md-4 control-label">Lokasi Kerja</label>
                                      <div class="col-md-4">
                                        <input class="form-control" id="lokasiKerja" placeholder="Lokasi Kerja">
                                      </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-4">
                                        <input class="form-control" id="tglSKnaikJabatan" placeholder="Tanggal SK Naik Jabatan">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="box-body scroll">
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-4">
                                        <input class="form-control" id="tglSK" placeholder="Tanggal SK">
                                      </div>
                                    </div>
                                    <div class="form-group">
                              ...
                              <form class="form-horizontal">
                                <div class="box-body scroll">
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                      <label for="SkTanggal" class="col-md-4 control-label">Tanggal SK</label>
                                      <div class="col-md-4">
                                        <input class="form-control" id="SkTanggal" placeholder="Tanggal SK">
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      <label for="TanggalAwal" class="col-md-4 control-label">Tanggal Mulai</label>
                                      <div class="col-md-4">
                                        <input class="form-control" id="TanggalAwal" placeholder="Tanggal Mulai">
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      <label for="TanggalAkhir" class="col-md-4 control-label">Tanggal Akhir</label>
                                      <div class="col-md-4">
                                        <input class="form-control" id="TanggalAkhir" placeholder="Tanggal Akhir">
                                      </div>
                                    </div>
                                    <div class="form-group">
