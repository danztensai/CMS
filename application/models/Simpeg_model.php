<?php class Simpeg_model extends CI_Model
{
    ...
    public function getHistoryAbsensiBawahan($key, $limitStart, $limitLength, $searchColumn, $draw, $orderByColumn, $orderByDir, $nip, $status, $bulan)
    {
    ...
    public function getHistoryAbsensi($key, $limitStart, $limitLength, $searchColumn, $draw, $orderByColumn, $orderByDir, $nip, $status, $bulan)
    {
        $orderBy = $orderByColumn;
        $orderQuery = '';
        if ($orderByColumn != 0) {
...
WHERE nip = '$nip' ORDER BY tanggalAkhirKursus DESC";
    ...
    public function getCurentDayBirthDay($key, $limitStart, $limitLength, $searchColumn, $draw, $orderByColumn, $orderByDir)
    {
        $orderBy = $orderByColumn;
        $orderQuery = '';
        if ($orderByColumn != 0) {
